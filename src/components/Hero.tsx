...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen pt-20 digital-pattern flex flex-col justify-center overflow-hidden">
      {/* Abstract background elements */}
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-blue-100 rounded-full filter blur-3xl opacity-50" />
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-blue-100 rounded-full filter blur-3xl opacity-50" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className={`max-w-2xl ${isLoaded ? "animate-fade-in" : "opacity-0"}`}>
            <div className="inline-block px-4 py-1 rounded-full bg-blue-50 border border-blue-100 mb-6">
              <p className="text-xs font-medium text-blue-700">Adaptive Security System</p>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Adaptive Data Leakage <span className="gradient-text">Detection</span> System
            </h1>
            ...
            <div className="mt-12 flex items-center gap-8">
              ...
              <div className="flex flex-col items-center">
                <h3 className="text-2xl font-bold mb-1">0.1%</h3>
          ...
          <div className={`flex-1 ${isLoaded ? "animate-fade-in-delay" : "opacity-0"}`}>
            <div className="relative w-full h-full">
              <div className="glass p-6 rounded-2xl shadow-xl max-w-md mx-auto">
              ...
              <div className="absolute -bottom-6 -right-6 glass p-3 rounded-lg shadow-lg animate-flow">
                <div className="flex items-center gap-2">
